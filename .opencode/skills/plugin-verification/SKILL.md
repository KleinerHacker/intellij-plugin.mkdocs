...
description: Rules for verifyPlugin - the authoritative IDE matrix in plugin/build.gradle.kts, the version catalog entry it MUST read, the compatibility range and how to treat its result. Read before running verifyPlugin or touching the ides { } matrix, sinceBuild or untilBuild.
---
