 ...
 *
 * Kept apart from the registry of the plugin because the feature owns them: what the theme looks like is none
 * of the plugin's business, and a plugin without this feature ships none of these files.
 *
...
object MkDocsMaterialIcons {
    ...
    private fun load(fileName: String, size: Int): Icon =
        MkDocsIconLoader.load("/material/icons/$fileName", size, MkDocsMaterialIcons::class.java)
}
