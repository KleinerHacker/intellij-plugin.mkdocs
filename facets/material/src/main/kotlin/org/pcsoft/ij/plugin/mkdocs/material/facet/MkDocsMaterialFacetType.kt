 ...
 * The connection between the two is therefore kept by the site detection of the plugin, which only ever
 * adds this facet next to an MkDocs facet and drops it together with it.
 *
