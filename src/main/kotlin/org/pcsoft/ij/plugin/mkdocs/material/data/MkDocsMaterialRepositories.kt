...
/**
 * The Markdown extensions read from `facets/material/markdown-extensions.yaml`.
 *
...
/**
 * The feature flags read from `facets/material/feature-flags.yaml`.
 *
...
/**
 * The `extra` keys read from `facets/material/extra-keys.yaml`.
 *
...
/**
 * The curated font families read from `facets/material/fonts.yaml`.
 *
...
/**
 * The palette colours read from `facets/material/colors.yaml`.
 *
