 ...
 * schema — a truncated download or a moved resource would leave every Material site without validation.
 */
class MkDocsVendoredSchemaTest : TestCase() {
    ...
    private fun read() =
        javaClass.getResourceAsStream(MkDocsMaterialSchemaGenerator.BASE_RESOURCE)!!
